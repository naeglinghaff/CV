...
| Space Trash          | A 7 day group project focused around machine learning and space debris. The application visualises space debris and satellite data, using a model to make predictions for individual objects in orbit. | Applying agile processes meant that we were able to take a day out to conduct some deeper research into the concept of machine learning and still construct our newly defined MVP over the next 2 day sprint.                                                                                                                                                                                                                                                                                                                                                                                      | Python, Django, JavaScript, deployed with Heroku, tested with unittest           | https://space-trash.herokuapp.com/ \| https://github.com/The-Mech-Squad/the_mech_squad |
